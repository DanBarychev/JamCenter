...
SWIFT_MODULE_NAMESPACE_PUSH("SwiftVideoBackground")
@class NSCoder;
...
///   </li>
/// </ul>
- (void)createBackgroundVideoWithName:(NSString * _Nonnull)name type:(NSString * _Nonnull)type;
...
///   </li>
/// </ul>
- (void)createBackgroundVideoWithName:(NSString * _Nonnull)name type:(NSString * _Nonnull)type alpha:(CGFloat)alpha;
